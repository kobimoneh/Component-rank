...
const api: RendererApi = {
  ...
  listSections: () => invoke(MUTATION_CHANNELS.sectionList),
  createSection: (req) => invoke(MUTATION_CHANNELS.sectionCreate, req),
  renameSection: (req) => invoke(MUTATION_CHANNELS.sectionRename, req),
  deleteSection: (req) => invoke(MUTATION_CHANNELS.sectionDelete, req),
  moveSection: (req) => invoke(MUTATION_CHANNELS.sectionMove, req),
  setFamilySection: (req) => invoke(MUTATION_CHANNELS.familySetSection, req),
  createFamily: (req) => invoke(MUTATION_CHANNELS.familyCreate, req),
  renameFamily: (req) => invoke(MUTATION_CHANNELS.familyRename, req),
  familyImpact: (req) => invoke(MUTATION_CHANNELS.familyImpact, req),
  deleteFamily: (req) => invoke(MUTATION_CHANNELS.familyDelete, req),
  setComponentFamily: (req) => invoke(MUTATION_CHANNELS.componentSetFamily, req),
  removeFromFamily: (req) => invoke(MUTATION_CHANNELS.componentRemoveFromFamily, req),
  componentFamilies: (req) => invoke(MUTATION_CHANNELS.componentFamilies, req),
  setLifecycle: (req) => invoke(MUTATION_CHANNELS.componentSetLifecycle, req),
  deleteComponents: (req) => invoke(MUTATION_CHANNELS.componentsDelete, req),
